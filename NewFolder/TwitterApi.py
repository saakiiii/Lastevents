...
class TwitterApi:
    ...
    def __init__(self):
        # self.twitterapi  = Client(bearer_token=BEARER_TOKEN, consumer_key=CONSUMER_KEY, consumer_secret=CONSUMER_SECRET, access_token=ACCESS_TOKEN, access_token_secret=ACCESS_TOKEN_SECRET, wait_on_rate_limit=True)
...
# TwitterApi().Tweet(text="www.lastevents.space")